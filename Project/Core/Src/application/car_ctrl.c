	    ...
	    switch(verticalLightState) {
	        case LIGHT_GREEN:
	            if (events & DIR_EVENT_REQUEST_STOP) {
	                ...
	                SetCarLaneLight(LANE_1, LIGHT_ORANGE); // North
	                SetCarLaneLight(LANE_3, LIGHT_ORANGE); // South
	                osDelay(config.orangeDelay);
	                verticalLightState = LIGHT_RED;
	                SetCarLaneLight(LANE_1, LIGHT_RED);
	                SetCarLaneLight(LANE_3, LIGHT_RED);
	        ...
	        case LIGHT_RED:
	            if (events & DIR_EVENT_REQUEST_GO) {
	                verticalLightState = LIGHT_ORANGE;
	                SetCarLaneLight(LANE_1, LIGHT_ORANGE);
	                SetCarLaneLight(LANE_3, LIGHT_ORANGE);
	                osDelay(config.orangeDelay);
	                verticalLightState = LIGHT_GREEN;
	                SetCarLaneLight(LANE_1, LIGHT_GREEN);
	                SetCarLaneLight(LANE_3, LIGHT_GREEN);
	    ...
	    switch(horizontalLightState) {
	        case LIGHT_GREEN:
	            if (events & DIR_EVENT_REQUEST_STOP) {
	                ...
	                SetCarLaneLight(LANE_2, LIGHT_ORANGE); // West
	                SetCarLaneLight(LANE_4, LIGHT_ORANGE); // East
	                osDelay(config.orangeDelay);
	                horizontalLightState = LIGHT_RED;
	                SetCarLaneLight(LANE_2, LIGHT_RED);
	                SetCarLaneLight(LANE_4, LIGHT_RED);
	        ...
	        case LIGHT_RED:
	            if (events & DIR_EVENT_REQUEST_GO) {
	                horizontalLightState = LIGHT_ORANGE;
	                SetCarLaneLight(LANE_2, LIGHT_ORANGE);
	                SetCarLaneLight(LANE_4, LIGHT_ORANGE);
	                osDelay(config.orangeDelay);
	                horizontalLightState = LIGHT_GREEN;
	                SetCarLaneLight(LANE_2, LIGHT_GREEN);
	                SetCarLaneLight(LANE_4, LIGHT_GREEN);
